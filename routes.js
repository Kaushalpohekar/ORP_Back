...
router.post('/get-Analytics-Data-OnTime-Total-customs/:deviceId', dashboard.getAnalyticsDataOnTimeTotalPieCharts);
router.get('/get-Analytics-Data-OnTime-Total-interval/:deviceId/intervals', dashboard.getDataByTimeIntervalAnalyticsPieChart);
...
router.get('/get-Analytics-Data-Bar-Total-interval/:deviceId/intervals', dashboard.TotalONOFFIntervalByDays);
router.get('/get-Analytics-Data-Bar-Total-Custom/:deviceId', dashboard.TotalONOFFCustomByDays);
router.get('/getLatestEntry/:companyEmail', dashboard.fetchLatestEntry);
